...
public class RecyclerView extends ViewGroup {
     ...
     * forwards the call to {@link android.support.v7.widget.RecyclerView.LayoutManager#scrollToPosition(int)}
     * 
     ...
     * {@link RecyclerView.LayoutManager#computeHorizontalScrollOffset(RecyclerView.State)} in your LayoutManager.
     * </p>
     * 
     * @return The horizontal offset of the scrollbar's thumb
     * @see android.support.v7.widget.RecyclerView.LayoutManager#computeHorizontalScrollOffset (RecyclerView.Adapter)
     */
    @Override
     ...
     * <p>
     * If you want to support scroll bars, override
     * {@link RecyclerView.LayoutManager#computeHorizontalScrollExtent(RecyclerView.State)} in your LayoutManager.
     * </p>
     * 
     ...
     * <p>
     * If you want to support scroll bars, override
     * {@link RecyclerView.LayoutManager#computeHorizontalScrollRange(RecyclerView.State)} in your LayoutManager.
     * </p>
     * 
     ...
     * <p>
     * If you want to support scroll bars, override
     * {@link RecyclerView.LayoutManager#computeVerticalScrollOffset(RecyclerView.State)} in your LayoutManager.
     * </p>
     * 
     * @return The vertical offset of the scrollbar's thumb
     * @see android.support.v7.widget.RecyclerView.LayoutManager#computeVerticalScrollOffset (RecyclerView.Adapter)
     */
    @Override
     ...
     * <p>
     * If you want to support scroll bars, override
     * {@link RecyclerView.LayoutManager#computeVerticalScrollExtent(RecyclerView.State)} in your LayoutManager.
     * </p>
     * 
     ...
     * <p>
     * If you want to support scroll bars, override
     * {@link RecyclerView.LayoutManager#computeVerticalScrollRange(RecyclerView.State)} in your LayoutManager.
     * </p>
     * 
     ...
     * Clean views that have not {@link android.view.View#isLayoutRequested() requested layout} may be repositioned by a
    ...
    public final class Recycler {
        ...
        boolean validateViewHolderForOffsetPosition(ViewHolder holder , int offsetPosition) {
            ...
            return !mAdapter.hasStableIds() || holder.getItemId() == mAdapter.getItemId(offsetPosition);
        }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
         ...
         * previously freed any resources in {@link #onViewDetachedFromWindow(RecyclerView.ViewHolder)
         ...
         * {@link android.support.v7.widget.RecyclerView.AdapterDataObserver#onChanged() "something changed"} event if
    ...
    public static abstract class LayoutManager {
         ...
         * specific to the layout. Client code should subclass {@link RecyclerView.LayoutParams} for this purpose.
         * </p>
         * <p>
         * <em>Important:</em> if you use your own custom <code>LayoutParams</code> type you must also override
         * {@link #checkLayoutParams(LayoutParams)}, {@link #generateLayoutParams(android.view.ViewGroup.LayoutParams)}
         * and {@link #generateLayoutParams(android.content.Context, android.util.AttributeSet)}.
         * </p>
         * 
         ...
         * 
         * @return {@link android.support.v4.view.ViewCompat#LAYOUT_DIRECTION_RTL} if the layout direction is RTL or
         *         returns {@link android.support.v4.view.ViewCompat#LAYOUT_DIRECTION_LTR} if the layout direction is
         *         not RTL.
         */
         ...
         * removed views using {@link Recycler#recycleView(android.view.View)}.
         * 
         ...
         * {@link #detachAndScrapView(android.view.View, RecyclerView.Recycler)} so that the detached view may be
         * rebound and reused.
         * </p>
         * <p>
         * If a LayoutManager uses this method to detach a view, it <em>must</em>
         * {@link #attachView(android.view.View, int, RecyclerView.LayoutParams) reattach} or
         * {@link #removeDetachedView(android.view.View) fully remove} the detached view before the LayoutManager entry
        ...
        /**
         * Reattach a previously {@link #detachView(android.view.View) detached} view. This method should not be used to
         * reattach views that were previously {@link #detachAndScrapView(android.view.View, RecyclerView.Recycler)}
         * scrapped}.
         * 
        ...
        /**
         * Finish removing a view that was previously temporarily {@link #detachView(android.view.View) detached}.
         * 
        ...
        public static int getChildMeasureSpec(int parentSize , int padding , int childDimension , boolean canScroll) {
            ...
            if (canScroll) {
                ...
                else if (childDimension == android.view.ViewGroup.LayoutParams.FILL_PARENT) {
                    resultSize = size;
                    resultMode = MeasureSpec.EXACTLY;
                }
         ...
         * {@link #onFocusSearchFailed(View, int, RecyclerView.Recycler, RecyclerView.State)} will be called to give the
         ...
         * {@link ViewParent#requestChildRectangleOnScreen(android.view.View, android.graphics.Rect, boolean)} for more
         * details.
         * <p>
         ...
         * @param newAdapter The new adapter instance. Might be null if {@link #setAdapter(RecyclerView.Adapter)} is
         ...
         * {@link ViewGroup#addFocusables(java.util.ArrayList, int)} should be suppressed.
         * </p>
         * <p>
    ...
    /**
     * {@link android.view.ViewGroup.MarginLayoutParams LayoutParams} subclass for children of {@link RecyclerView}.
    ...
    public static abstract class SmoothScroller {
         ...
         * {@link #onSeekTargetStep(int, int, RecyclerView.State, SmoothScroller.Action)} until SmoothScroller is
         * stopped.
         * </p>
         * <p>
